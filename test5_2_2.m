...
axis([0 8 -100 100]); xticks(0:1:8);yticks(-100:50:100);
...
axis([0 8 -80 80]); xticks(0:1:8);yticks(-80:40:80);
...
axis([0 8 -240 240]); xticks(0:1:8);yticks(-240:80:240);


% sgtitle('Angle velocity tracking error under different control', 'FontSize', 8,'FontName','Times New Roman');


PlotToFileColorPDF(fig1,'results/Figure_14a.pdf',6.5,10.5); % rate_tracking
...
PlotToFileColorPDF(fig2,'results/Figure_14b.pdf',6.5,10.5); % att_tracking
...
axis([0 8 -5 20]); xticks(0:1:8);yticks(-5:5:20);
...
PlotToFileColorPDF(fig3,'results/Figure_15a.pdf',6.5,15.5); % Alloc_error
...
PlotToFileColorPDF(fig4,'results/Figure_15b.pdf',6.5,15.5); % Alloc_u
...
PlotToFileColorPDF(fig5, 'results/Figure_16.pdf', 7.5, 7.5); % position_tracking
% PlotToFileColorPNG(fig5, 'results/position_tracking.png', 20, 15);
